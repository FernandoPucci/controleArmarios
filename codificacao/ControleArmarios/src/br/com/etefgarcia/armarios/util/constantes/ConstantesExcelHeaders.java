 ...
 */
public class ConstantesExcelHeaders {
    ...
    public static final int COLUNA_RM = 0;
    public static final int COLUNA_NOME = 1;
    public static final int COLUNA_TELEFONE = 8;
    public static final int COLUNA_CELULAR = 9;
